...
export const SESSION_REFERENCE_DRAG_MIME = 'application/x-profer-session-reference'
 ...
 */
export const INSERT_SESSION_REFERENCE_MENTION_EVENT = 'profer:insert-session-reference-mention'
